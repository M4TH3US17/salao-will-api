...
import br.com.salao.entidades.cliente.core.data.*;
...
public class ClienteService {
	...
	public ClienteDTO findByLogin(String login) throws Exception {
		Cliente cliente = repository.findById(login)
				.orElseThrow(() -> new ClienteNotFoundException("Cliente com login " +login+" não foi encontrado."));
	...
	@Modifying
	@Transactional
	public ClienteDTO update(String login, ModifyClienteDTO obj) throws Exception {
		Cliente entity = repository.findById(login)
				.orElseThrow(() -> new ClienteNotFoundException("Cliente com login " +login+" não foi encontrado."));
	...
	public String confirmEmail(String login, ConfirmationEmailDTO code) throws Exception {
		Cliente obj = repository.findById(login)
				.orElseThrow(() -> new ClienteNotFoundException("Cliente com login " +login+" não foi encontrado."));
